...
$stdout = Join-Path $env:TEMP ("patient-consent-audit-stream-" + [guid]::NewGuid().ToString() + "-stdout.log")
$stderr = Join-Path $env:TEMP ("patient-consent-audit-stream-" + [guid]::NewGuid().ToString() + "-stderr.log")
$port = "5450"
$process = $null
$edgeCandidates = @(
...
try {
    ...
    $targets = @(
        ...
        @{ Url = "http://127.0.0.1:$port/consent-lane"; File = "02-consent-lane-proof.png"; Size = "1600,1320" },
        @{ Url = "http://127.0.0.1:$port/audit-stream"; File = "03-audit-stream-proof.png"; Size = "1600,1220" },
        @{ Url = "http://127.0.0.1:$port/revocation-posture"; File = "04-revocation-posture-proof.png"; Size = "1600,1220" }
    )
